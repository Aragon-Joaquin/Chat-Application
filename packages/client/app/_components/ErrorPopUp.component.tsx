	...
	return (
		<ToastProvider swipeDirection="right">
			<Toast
				...
				className="relative bg-neutral-100 border-2 border-neutral-950/20 p-2 rounded-md rounded-l-none shadow-xl grid grid-cols-[225px_auto] auto-rows-auto
			...
			<ToastViewport className="absolute right-0 bottom-0 z-50 min-h-28 max-h-72 w-80 mr-5 mb-5 flex justify-center" />
		</ToastProvider>
	)
}
