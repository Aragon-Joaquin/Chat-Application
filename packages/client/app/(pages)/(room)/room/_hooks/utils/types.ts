...
type SelectWSAction<T extends keyof typeof WS_ACTIONS> = Extract<keyof typeof WS_ACTIONS, T>
...
export type PICK_WS_PAYLOAD<T extends keyof typeof WS_ACTIONS> = Extract<wsPayloads, { action: T }>['payload']
